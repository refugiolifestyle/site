...
export default async function Evento({ params }: EventoProps) {
    ...
    return <>
        <img
            ...
            className="absolute bottom-0 left-0 top-0 right-0 object-cover z-[-1] w-full h-full min-h-screen brightness-50" />
        <div className="flex flex-col lg:flex-row justify-around items-center space-y-20 md:space-y-0 space-x-0 md:space-x-20 w-full">
            <Image
                width={300}
                height={300}
                priority={true}
