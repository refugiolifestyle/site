...
export default function Finalizacao({ inscrito, reset, evento }: StepProps) {
    return <Card className="w-full max-w-sm">
        ...
        <CardContent className="space-y-4 text-justify">
            <p>Olá, seu pagamento foi processado com sucesso, a cada dia que passa estamos mais ansiosos para viver tudo o que Deus tem preparado para <b>{evento.titulo}</b>.</p>
